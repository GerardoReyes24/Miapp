...
(function (Miapp2) {
    ...
    })(Administration = Miapp2.Administration || (Miapp2.Administration = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    var Administration;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Miapp2.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = Miapp2.Northwind.OrderDetailsEditor;
...
(function (Miapp2) {
    var BasicSamples;
    (function (BasicSamples) {
        var ProductionreportService;
        (function (ProductionreportService) {
            ProductionreportService.baseUrl = 'Northwind/Productionreport';
            [
                'List'
            ].forEach(function (x) {
                ProductionreportService[x] = function (r, s, o) {
                    return Q.serviceRequest(ProductionreportService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(ProductionreportService = BasicSamples.ProductionreportService || (BasicSamples.ProductionreportService = {}));
    })(BasicSamples = Miapp2.BasicSamples || (Miapp2.BasicSamples = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
...
(function (Miapp2) {
    ...
    (function (Northwind) {
        ...
        (function (CustomerGrossSalesRow) {
            CustomerGrossSalesRow.nameProperty = 'ProyectorName';
...
(function (Miapp2) {
    var Northwind;
    (function (Northwind) {
        var DesignForm = /** @class */ (function (_super) {
            __extends(DesignForm, _super);
            function DesignForm(prefix) {
                var _this = _super.call(this, prefix) || this;
                if (!DesignForm.init) {
            ...
            DesignForm.formKey = 'Northwind.Design';
            return DesignForm;
        }(Serenity.PrefixedContext));
        Northwind.DesignForm = DesignForm;
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    ...
    (function (Northwind) {
        var DesignRow;
        (function (DesignRow) {
            DesignRow.idProperty = 'DesignId';
            DesignRow.localTextPrefix = 'Northwind.Design';
        })(DesignRow = Northwind.DesignRow || (Northwind.DesignRow = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    ...
    (function (Northwind) {
        ...
        (function (DesignService) {
            DesignService.baseUrl = 'Northwind/Design';
            [
                'Create',
                'Update',
                'Delete',
                ...
                DesignService[x] = function (r, s, o) {
                    return Q.serviceRequest(DesignService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(DesignService = Northwind.DesignService || (Northwind.DesignService = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    ...
    (function (Northwind) {
        var DesignStatusRow;
        (function (DesignStatusRow) {
            DesignStatusRow.idProperty = 'ProjectID';
            DesignStatusRow.localTextPrefix = 'Northwind.DesignStatus';
        })(DesignStatusRow = Northwind.DesignStatusRow || (Northwind.DesignStatusRow = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    var Northwind;
    (function (Northwind) {
        var DesignTypeForm = /** @class */ (function (_super) {
            __extends(DesignTypeForm, _super);
            function DesignTypeForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            DesignTypeForm.formKey = 'Northwind.DesignType';
            return DesignTypeForm;
        }(Serenity.PrefixedContext));
        Northwind.DesignTypeForm = DesignTypeForm;
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    ...
    (function (Northwind) {
        var DesignTypeRow;
        (function (DesignTypeRow) {
            DesignTypeRow.idProperty = 'DesignTypeId';
            DesignTypeRow.nameProperty = 'DesType';
            DesignTypeRow.localTextPrefix = 'Northwind.DesignType';
            DesignTypeRow.lookupKey = 'Northwind.DesignType';
            function getLookup() {
                return Q.getLookup('Northwind.DesignType');
            }
            DesignTypeRow.getLookup = getLookup;
        })(DesignTypeRow = Northwind.DesignTypeRow || (Northwind.DesignTypeRow = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    var Northwind;
    (function (Northwind) {
        var DesignTypeService;
        (function (DesignTypeService) {
            DesignTypeService.baseUrl = 'Northwind/DesignType';
            [
                'Create',
                'Update',
                'Delete',
                ...
                DesignTypeService[x] = function (r, s, o) {
                    return Q.serviceRequest(DesignTypeService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(DesignTypeService = Northwind.DesignTypeService || (Northwind.DesignTypeService = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
...
(function (Miapp2) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'Miapp2.Northwind.Gender', 'Miapp2.Northwind.Entities.Gender');
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
...
(function (Miapp2) {
    var Northwind;
    (function (Northwind) {
        var PriorityForm = /** @class */ (function (_super) {
            __extends(PriorityForm, _super);
            function PriorityForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            PriorityForm.formKey = 'Northwind.Priority';
            return PriorityForm;
        }(Serenity.PrefixedContext));
        Northwind.PriorityForm = PriorityForm;
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    ...
    (function (Northwind) {
        ...
        (function (PriorityRow) {
            PriorityRow.idProperty = 'PriorityId';
            PriorityRow.nameProperty = 'PriorityDescription';
            PriorityRow.localTextPrefix = 'Northwind.Priority';
            PriorityRow.lookupKey = 'Northwind.Priority';
            function getLookup() {
                return Q.getLookup('Northwind.Priority');
            }
            PriorityRow.getLookup = getLookup;
        })(PriorityRow = Northwind.PriorityRow || (Northwind.PriorityRow = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    ...
    (function (Northwind) {
        ...
        (function (PriorityService) {
            PriorityService.baseUrl = 'Northwind/Priority';
            [
                'Create',
                'Update',
                'Delete',
                ...
                PriorityService[x] = function (r, s, o) {
                    return Q.serviceRequest(PriorityService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(PriorityService = Northwind.PriorityService || (Northwind.PriorityService = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    ...
    (function (Northwind) {
        var ProdStatus;
        (function (ProdStatus) {
            ProdStatus[ProdStatus["Empezado"] = 1] = "Empezado";
            ProdStatus[ProdStatus["EnProceso"] = 2] = "EnProceso";
            ProdStatus[ProdStatus["Terminado"] = 3] = "Terminado";
        })(ProdStatus = Northwind.ProdStatus || (Northwind.ProdStatus = {}));
...
(function (Miapp2) {
    var Northwind;
    (function (Northwind) {
        var ProductionForm = /** @class */ (function (_super) {
            __extends(ProductionForm, _super);
            function ProductionForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            ProductionForm.formKey = 'Northwind.Production';
            return ProductionForm;
        }(Serenity.PrefixedContext));
        Northwind.ProductionForm = ProductionForm;
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    ...
    (function (Northwind) {
        ...
        (function (ProductionRow) {
            ProductionRow.idProperty = 'ProductionId';
            ProductionRow.localTextPrefix = 'Northwind.Production';
        })(ProductionRow = Northwind.ProductionRow || (Northwind.ProductionRow = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    ...
    (function (Northwind) {
        ...
        (function (ProductionService) {
            ProductionService.baseUrl = 'Northwind/Production';
            [
                'Create',
                'Update',
                'Delete',
                ...
                ProductionService[x] = function (r, s, o) {
                    return Q.serviceRequest(ProductionService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(ProductionService = Northwind.ProductionService || (Northwind.ProductionService = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    ...
    (function (Northwind) {
        var ProductionStRow;
        (function (ProductionStRow) {
            ProductionStRow.idProperty = 'DetailID';
            ProductionStRow.localTextPrefix = 'Northwind.ProductionSt';
        })(ProductionStRow = Northwind.ProductionStRow || (Northwind.ProductionStRow = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    var Northwind;
    (function (Northwind) {
        var ProductionreportRow;
        (function (ProductionreportRow) {
            ProductionreportRow.localTextPrefix = 'Northwind.Productionreport';
        })(ProductionreportRow = Northwind.ProductionreportRow || (Northwind.ProductionreportRow = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    var Northwind;
    (function (Northwind) {
        var ProjectDetailsForm = /** @class */ (function (_super) {
            __extends(ProjectDetailsForm, _super);
            function ProjectDetailsForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            ProjectDetailsForm.formKey = 'Northwind.ProjectDetails';
            return ProjectDetailsForm;
        }(Serenity.PrefixedContext));
        Northwind.ProjectDetailsForm = ProjectDetailsForm;
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
...
(function (Miapp2) {
    ...
    (function (Northwind) {
        ...
        (function (ProjectDetailsService) {
            ProjectDetailsService.baseUrl = 'Northwind/ProjectDetails';
            [
                'Create',
                'Update',
                'Delete',
                ...
                ProjectDetailsService[x] = function (r, s, o) {
                    return Q.serviceRequest(ProjectDetailsService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(ProjectDetailsService = Northwind.ProjectDetailsService || (Northwind.ProjectDetailsService = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
        ...
        var ProjectsForm = /** @class */ (function (_super) {
            ...
            function ProjectsForm(prefix) {
                ...
                if (!ProjectsForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.BooleanEditor;
                    var w4 = Northwind.ProjectDetailsEditor;
            ...
            ProjectsForm.formKey = 'Northwind.Projects';
            return ProjectsForm;
        }(Serenity.PrefixedContext));
        Northwind.ProjectsForm = ProjectsForm;
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
...
(function (Miapp2) {
    ...
    (function (Northwind) {
        ...
        (function (ProjectsService) {
            ProjectsService.baseUrl = 'Northwind/Projects';
            [
                'Create',
                'Update',
                'Delete',
...
(function (Miapp2) {
    var Northwind;
    (function (Northwind) {
        var RUbicacionForm = /** @class */ (function (_super) {
            __extends(RUbicacionForm, _super);
            function RUbicacionForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            RUbicacionForm.formKey = 'Northwind.RUbicacion';
            return RUbicacionForm;
        }(Serenity.PrefixedContext));
        Northwind.RUbicacionForm = RUbicacionForm;
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    ...
    (function (Northwind) {
        var RUbicacionRow;
        (function (RUbicacionRow) {
            RUbicacionRow.idProperty = 'RUbicacionId';
            RUbicacionRow.nameProperty = 'RUbicacionN';
            RUbicacionRow.localTextPrefix = 'Northwind.RUbicacion';
            RUbicacionRow.lookupKey = 'Northwind.RUbicacion';
            function getLookup() {
                return Q.getLookup('Northwind.RUbicacion');
            }
            RUbicacionRow.getLookup = getLookup;
        })(RUbicacionRow = Northwind.RUbicacionRow || (Northwind.RUbicacionRow = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    var Northwind;
    (function (Northwind) {
        var RUbicacionService;
        (function (RUbicacionService) {
            RUbicacionService.baseUrl = 'Northwind/RUbicacion';
            [
                'Create',
                'Update',
                'Delete',
                ...
                RUbicacionService[x] = function (r, s, o) {
                    return Q.serviceRequest(RUbicacionService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(RUbicacionService = Northwind.RUbicacionService || (Northwind.RUbicacionService = {}));
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Miapp2.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Miapp2.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Miapp2.Northwind.OrderDialog();
                        ...
                        var chai = Miapp2.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Miapp2.Northwind.EmployeeRow.getLookup().items
        ...
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Miapp2.Northwind.CategoryService.Retrieve({
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Miapp2.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Miapp2.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Miapp2.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Miapp2.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Miapp2.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Miapp2.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Miapp2.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Miapp2.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Miapp2.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Miapp2.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Miapp2.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Miapp2.Northwind.OrderService.baseUrl; };
...
(function (Miapp2) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Miapp2.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Miapp2.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Miapp2.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Miapp2.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Miapp2.Northwind.OrderService.baseUrl; };
...
(function (Miapp2) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Miapp2.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Miapp2.Northwind.CustomerDialog));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = Miapp2.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Miapp2.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Miapp2.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Miapp2.Northwind.OrderDetailForm(_this.idPrefix);
...
(function (Miapp2) {
    ...
    (function (BasicSamples) {
        ...
        }(Miapp2.Northwind.OrderDetailsEditor));
...
(function (Miapp2) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Miapp2.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Miapp2.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Miapp2.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Miapp2.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Miapp2.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (Miapp2) {
    ...
    (function (BasicSamples) {
        ...
        }(Miapp2.Common.BulkServiceAction));
...
(function (Miapp2) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Miapp2.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Miapp2.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Miapp2.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Miapp2.Northwind.ProductService.baseUrl; };
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Miapp2.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Miapp2.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                    ...
                    new Miapp2.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (Miapp2) {
    ...
    Miapp2.SelectableEntityGrid = SelectableEntityGrid;
})(Miapp2 || (Miapp2 = {}));
...
(function (Miapp2) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Miapp2.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Miapp2.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Miapp2.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Miapp2.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Miapp2.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = Miapp2.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Miapp2.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Miapp2) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Miapp2.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Miapp2.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Miapp2.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Miapp2.Northwind.ProductService.baseUrl; };
...
(function (Miapp2) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Miapp2.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Miapp2.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Miapp2.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Miapp2.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Miapp2) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Miapp2.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Miapp2.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Miapp2) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Miapp2.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Miapp2.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Miapp2.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (Miapp2) {
    var Northwind;
    (function (Northwind) {
        var RUbicacionDialog = /** @class */ (function (_super) {
            __extends(RUbicacionDialog, _super);
            function RUbicacionDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Northwind.RUbicacionForm(_this.idPrefix);
                return _this;
            }
            RUbicacionDialog.prototype.getFormKey = function () { return Northwind.RUbicacionForm.formKey; };
            RUbicacionDialog.prototype.getIdProperty = function () { return Northwind.RUbicacionRow.idProperty; };
            RUbicacionDialog.prototype.getLocalTextPrefix = function () { return Northwind.RUbicacionRow.localTextPrefix; };
            RUbicacionDialog.prototype.getNameProperty = function () { return Northwind.RUbicacionRow.nameProperty; };
            RUbicacionDialog.prototype.getService = function () { return Northwind.RUbicacionService.baseUrl; };
            RUbicacionDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], RUbicacionDialog);
            return RUbicacionDialog;
        }(Serenity.EntityDialog));
        Northwind.RUbicacionDialog = RUbicacionDialog;
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
    var Northwind;
    (function (Northwind) {
        var RUbicacionGrid = /** @class */ (function (_super) {
            __extends(RUbicacionGrid, _super);
            function RUbicacionGrid(container) {
                return _super.call(this, container) || this;
            }
            RUbicacionGrid.prototype.getColumnsKey = function () { return 'Northwind.RUbicacion'; };
            RUbicacionGrid.prototype.getDialogType = function () { return Northwind.RUbicacionDialog; };
            RUbicacionGrid.prototype.getIdProperty = function () { return Northwind.RUbicacionRow.idProperty; };
            RUbicacionGrid.prototype.getLocalTextPrefix = function () { return Northwind.RUbicacionRow.localTextPrefix; };
            RUbicacionGrid.prototype.getService = function () { return Northwind.RUbicacionService.baseUrl; };
            RUbicacionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RUbicacionGrid);
            return RUbicacionGrid;
        }(Serenity.EntityGrid));
        Northwind.RUbicacionGrid = RUbicacionGrid;
    })(Northwind = Miapp2.Northwind || (Miapp2.Northwind = {}));
})(Miapp2 || (Miapp2 = {}));
var Miapp2;
(function (Miapp2) {
