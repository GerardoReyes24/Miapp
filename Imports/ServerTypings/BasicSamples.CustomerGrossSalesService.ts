namespace Miapp2.BasicSamples {
    export namespace CustomerGrossSalesService {
        ...
        export declare function List(request: CustomerGrossSalesListRequest, onSuccess?: (response: Serenity.ListResponse<Northwind.ProductionreportRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
