namespace Miapp2.Northwind {
    export namespace ProductionService {
        ...
        export declare function List(request: Northwind.Production.ProductionListRequest, onSuccess?: (response: Serenity.ListResponse<ProductionRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
