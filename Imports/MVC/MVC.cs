...
namespace MVC
{
    public static class Views
    {
        ...
        public static class ImportFiles
        {
            ...
            {
                public const string PiezaIndex = "~/Modules/ImportFiles/Pieza/PiezaIndex.cshtml";
            }
        }

        public static class IntOut
        {
            public const string InOut = "~/Modules/IntOut/InOut.cshtml";
        }
        ...
        public static class Northwind
        {
            ...
            public static class Cotiza
            {
                public const string CotizaIndex = "~/Modules/Northwind/Cotiza/CotizaIndex.cshtml";
            }
            ...
            {
                public const string DesignIndex = "~/Modules/Northwind/Design/DesignIndex.cshtml";
            }

            public static class DesignType
            {
                public const string DesignTypeIndex = "~/Modules/Northwind/DesignType/DesignTypeIndex.cshtml";
            }

            public static class Metod
            {
                public const string MisdatosIndex = "~/Modules/Northwind/Metod/MisdatosIndex.cshtml";
            }
            ...
            {
                public const string PriorityIndex = "~/Modules/Northwind/Priority/PriorityIndex.cshtml";
            }
            ...
            {
                public const string ProjectDetailsIndex = "~/Modules/Northwind/ProjectDetails/ProjectDetailsIndex.cshtml";
            }
